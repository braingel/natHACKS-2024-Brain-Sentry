    ...
    return (
        <div className="results-container">
            ...
            <div className="analytics-container">
                <h1 className="risk-info">You are at <span className="green">low</span> risk of neurodegenerative diseases.</h1>
                ...
                <div className="cards-container">
                    <div className="wpm">
                        ...
                        <h4 className="stats wpm-stats"><span className="green">110</span></h4> {/* conditional */}
                    </div>
                    <div className="pauses">
                        <h3 className="card-title">Pauses</h3>
                        <h4 className="stats pauses-stats"><span className="highlight">20</span></h4> {/* conditional */}
                    </div>
                    <div className="clarity">
                        <h3 className="card-title">Clarity</h3>
                        <h4 className="stats clarity-stats">Your tone and pitch remained <span className="highlight">steady</span> throughout the task.</h4> {/* conditional */}
                    </div>
                </div>
